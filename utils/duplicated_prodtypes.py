...
def _create_profile_cache(ssg_root):
    ...
    product_list = ['debian8', 'debian10', 'fedora', 'ol7', 'opensuse', 'rhel6', 'rhel7',
...
def find_profiles(ssg_root, path, obj_name):
    ...
    uses_debian_like_distro = 'debian8' in used_products or 'debian10' in used_products or 'ubuntu1404' in used_products or 'ubuntu1604' in used_products
